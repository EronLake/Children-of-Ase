...
const std::string CHARACTER_SPRITES_PATH = SPRITES_PATH + "Characters/";

const std::string SHANGO_PATH = CHARACTER_SPRITES_PATH + "Shango/";
const std::string YEMOJA_PATH = CHARACTER_SPRITES_PATH + "Yemoja/";
const std::string OYA_PATH = CHARACTER_SPRITES_PATH + "Oya/";
const std::string OSHOSI_PATH = CHARACTER_SPRITES_PATH + "Oshosi/";
