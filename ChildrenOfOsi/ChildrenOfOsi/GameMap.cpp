...
void GameMap::drawMap(float _x, float _y)
{
	if (LOAD_MAP) {
		...
		if (Party::dist_location_to_location(map1_1->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map1_1->getX() - _x, map1_1->getY() - _y, map1_1->getWidth(), map1_1->getHeight(), map1_1->sprite);
		if (Party::dist_location_to_location(map1_2->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map1_2->getX() - _x, map1_2->getY() - _y, map1_2->getWidth(), map1_2->getHeight(), map1_2->sprite);
		if (Party::dist_location_to_location(map1_3->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map1_3->getX() - _x, map1_3->getY() - _y, map1_3->getWidth(), map1_3->getHeight(), map1_3->sprite);
		if (Party::dist_location_to_location(map1_4->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map1_4->getX() - _x, map1_4->getY() - _y, map1_4->getWidth(), map1_4->getHeight(), map1_4->sprite);
		if (Party::dist_location_to_location(map1_5->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map1_5->getX() - _x, map1_5->getY() - _y, map1_5->getWidth(), map1_5->getHeight(), map1_5->sprite);

		if (Party::dist_location_to_location(map2_1->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map2_1->getX() - _x, map2_1->getY() - _y, map2_1->getWidth(), map2_1->getHeight(), map2_1->sprite);
		if (Party::dist_location_to_location(map2_2->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map2_2->getX() - _x, map2_2->getY() - _y, map2_2->getWidth(), map2_2->getHeight(), map2_2->sprite);
		if (Party::dist_location_to_location(map2_3->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map2_3->getX() - _x, map2_3->getY() - _y, map2_3->getWidth(), map2_3->getHeight(), map2_3->sprite);
		if (Party::dist_location_to_location(map2_4->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map2_4->getX() - _x, map2_4->getY() - _y, map2_4->getWidth(), map2_4->getHeight(), map2_4->sprite);
		if (Party::dist_location_to_location(map2_5->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map2_5->getX() - _x, map2_5->getY() - _y, map2_5->getWidth(), map2_5->getHeight(), map2_5->sprite);

		if (Party::dist_location_to_location(map3_1->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map3_1->getX() - _x, map3_1->getY() - _y, map3_1->getWidth(), map3_1->getHeight(), map3_1->sprite);
		if (Party::dist_location_to_location(map3_2->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map3_2->getX() - _x, map3_2->getY() - _y, map3_2->getWidth(), map3_2->getHeight(), map3_2->sprite);
		if (Party::dist_location_to_location(map3_3->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map3_3->getX() - _x, map3_3->getY() - _y, map3_3->getWidth(), map3_3->getHeight(), map3_3->sprite);
		if (Party::dist_location_to_location(map3_4->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map3_4->getX() - _x, map3_4->getY() - _y, map3_4->getWidth(), map3_4->getHeight(), map3_4->sprite);
		if (Party::dist_location_to_location(map3_5->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map3_5->getX() - _x, map3_5->getY() - _y, map3_5->getWidth(), map3_5->getHeight(), map3_5->sprite);

		if (Party::dist_location_to_location(map4_1->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map4_1->getX() - _x, map4_1->getY() - _y, map4_1->getWidth(), map4_1->getHeight(), map4_1->sprite);
		if (Party::dist_location_to_location(map4_2->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map4_2->getX() - _x, map4_2->getY() - _y, map4_2->getWidth(), map4_2->getHeight(), map4_2->sprite);
		if (Party::dist_location_to_location(map4_3->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map4_3->getX() - _x, map4_3->getY() - _y, map4_3->getWidth(), map4_3->getHeight(), map4_3->sprite);
		if (Party::dist_location_to_location(map4_4->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map4_4->getX() - _x, map4_4->getY() - _y, map4_4->getWidth(), map4_4->getHeight(), map4_4->sprite);
		if (Party::dist_location_to_location(map4_5->get_mid_loc(), { _x,_y }) < 9000)GameWindow::drawSprite(map4_5->getX() - _x, map4_5->getY() - _y, map4_5->getWidth(), map4_5->getHeight(), map4_5->sprite);
		/*
