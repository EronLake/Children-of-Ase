...
void GameMap::drawMap(float _x, float _y)
{
	...
	GameWindow::drawSprite(map1_5->getX() - _x, map1_5->getY() - _y, map1_5->getWidth(), map1_5->getHeight(), map1_5->sprite);
	...
	GameWindow::drawSprite(map2_5->getX() - _x, map2_5->getY() - _y, map2_5->getWidth(), map2_5->getHeight(), map2_5->sprite);
	...
	GameWindow::drawSprite(map3_5->getX() - _x, map3_5->getY() - _y, map3_5->getWidth(), map3_5->getHeight(), map3_5->sprite);
	...
	GameWindow::drawSprite(map4_5->getX() - _x, map4_5->getY() - _y, map4_5->getWidth(), map4_5->getHeight(), map4_5->sprite);

	GameWindow::drawSprite(map5_1->getX() - _x, map5_1->getY() - _y, map5_1->getWidth(), map5_1->getHeight(), map5_1->sprite);
	GameWindow::drawSprite(map5_2->getX() - _x, map5_2->getY() - _y, map5_2->getWidth(), map5_2->getHeight(), map5_2->sprite);
	GameWindow::drawSprite(map5_3->getX() - _x, map5_3->getY() - _y, map5_3->getWidth(), map5_3->getHeight(), map5_3->sprite);
	GameWindow::drawSprite(map5_4->getX() - _x, map5_4->getY() - _y, map5_4->getWidth(), map5_4->getHeight(), map5_4->sprite);
	GameWindow::drawSprite(map5_5->getX() - _x, map5_5->getY() - _y, map5_5->getWidth(), map5_5->getHeight(), map5_5->sprite);
