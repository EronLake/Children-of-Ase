...
HUD::HUD()
{
  ...
  this->keybind_attack01_rect = new Rectangle({HUD::KEYBIND_DISPLAY_X, HUD::KEYBIND_DISPLAY_Y}, HUD::KEYBIND_DISPLAY_WIDTH, HUD::KEYBIND_DISPLAY_HEIGHT);
  this->keybind_attack02_rect = new Rectangle({HUD::KEYBIND_DISPLAY_X, HUD::KEYBIND_DISPLAY_Y}, HUD::KEYBIND_DISPLAY_WIDTH, HUD::KEYBIND_DISPLAY_HEIGHT);
  this->keybind_attack03_rect = new Rectangle({HUD::KEYBIND_DISPLAY_X, HUD::KEYBIND_DISPLAY_Y}, HUD::KEYBIND_DISPLAY_WIDTH, HUD::KEYBIND_DISPLAY_HEIGHT);
  this->keybind_attack04_rect = new Rectangle({HUD::KEYBIND_DISPLAY_X, HUD::KEYBIND_DISPLAY_Y}, HUD::KEYBIND_DISPLAY_WIDTH, HUD::KEYBIND_DISPLAY_HEIGHT);
  ...
  this->keybind_attack01_tex = new Texture();
  this->keybind_attack02_tex = new Texture();
  this->keybind_attack03_tex = new Texture();
  this->keybind_attack04_tex = new Texture();
...
HUD::~HUD()
{
  ...
  delete this->keybind_attack01_rect;
  delete this->keybind_attack02_rect;
  delete this->keybind_attack03_rect;
  delete this->keybind_attack04_rect;
  ...
  delete this->keybind_attack01_tex;
  delete this->keybind_attack02_tex;
  delete this->keybind_attack03_tex;
  delete this->keybind_attack04_tex;
...
void HUD::loadTexture()
{
  ...
  this->keybind_attack01_tex->setFile(SPRITES_PATH + "HUD_KeybindDisplay_Attack01.png", 1);
  this->keybind_attack02_tex->setFile(SPRITES_PATH + "HUD_KeybindDisplay_Attack02.png", 1);
  this->keybind_attack03_tex->setFile(SPRITES_PATH + "HUD_KeybindDisplay_Attack03.png", 1);
  this->keybind_attack04_tex->setFile(SPRITES_PATH + "HUD_KeybindDisplay_Attack04.png", 1);
...
void HUD::setSprite()
{
  ...
  this->keybind_attack01_rect->sprite.setTexture(this->keybind_attack01_tex);
  this->keybind_attack02_rect->sprite.setTexture(this->keybind_attack02_tex);
  this->keybind_attack03_rect->sprite.setTexture(this->keybind_attack03_tex);
  this->keybind_attack04_rect->sprite.setTexture(this->keybind_attack04_tex);
...
void HUD::drawMinimap(Player *player, Hero* yemoja, Hero* oya, Hero* ogun)
{
  ...
  if(player->getX() < 0.0F)
    minimapCoordOffset.setXloc(0.0F);
  else if(player->getX() > HUD::MAP_WIDTH)
