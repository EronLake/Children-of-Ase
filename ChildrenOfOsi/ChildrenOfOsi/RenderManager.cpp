...
RenderManager::RenderManager(MessageLog * _mLog, TaskBuffer * _tBuffer, QuadTree * _renderQuadTree, ChildrenOfOsi* game_f, RiverObj* _rivObj, std::vector<WorldObj*>* _largeStruct, UniformGrid<WorldObj>* _worldobj_grid) : Manager(_mLog, _tBuffer)
{
	LOG("RenderingManager W/QT Object Constructed");
	

	renderHelper = new RenderHelper(_renderQuadTree, _rivObj, _largeStruct, _worldobj_grid);
	...
	task_map["Victory_Menu"] = &RenderHelper::draw_victory_menu;
