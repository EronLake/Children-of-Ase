...
RenderManager::RenderManager(MessageLog * _mLog, TaskBuffer * _tBuffer, QuadTree * _renderQuadTree, ChildrenOfOsi* game_f, RiverObj* _rivObj, std::vector<WorldObj*>* _largeStruct) : Manager(_mLog, _tBuffer)
{
	LOG("RenderingManager W/QT Object Constructed");
	

	renderHelper = new RenderHelper(_renderQuadTree, _rivObj, _largeStruct);
