...
struct Tutorial
{
  ...
  static constexpr float DIALOGUE_POPUP_X = 460.0F;
  static constexpr float DIALOGUE_POPUP_Y = 40.0F;
  static constexpr float DIALOGUE_POPUP_WIDTH = 500.0F;
  static constexpr float DIALOGUE_POPUP_HEIGHT = 500.0F;
